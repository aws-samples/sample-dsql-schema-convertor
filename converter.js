    ...
    convertSerialTypes(sql) {
        ...
        while ((match = serialRegex.exec(sql)) !== null) {
            ...
            if (!seen.has(colName)) {
                ...
                this.changes.push({
                    type: 'modified',
                    message: `Converted "${colName}" from ${serialType.toUpperCase()} to BIGINT GENERATED BY DEFAULT AS IDENTITY (CACHE 1) — SERIAL shorthand is not directly supported in DSQL`
                });
            }
        }
